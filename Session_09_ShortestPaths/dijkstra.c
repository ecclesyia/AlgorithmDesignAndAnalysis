...
/*
 * Session 09: Dijkstra's Shortest Path Algorithm in C
...
void runDijkstra(int graph[V][V], int src) {
    ...
    for (int count = 0; count < V - 1; count++) {
        ...
        for (int v = 0; v < V; v++) {
            ...
            // 2. There is an edge from u to v (graph[u][v] is non-zero).
...
int main() {
    ...
    printf("Starting from Source Vertex: 0\n\n");
    runDijkstra(graph, 0);
