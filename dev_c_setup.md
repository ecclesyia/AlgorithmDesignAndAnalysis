# Dev-C++ Installation and Setup Guide
...
## 2. Critical Configuration: Enable C99/C11 Standard
...
1. Open Dev-C++.
2. Go to the top menu and select Tools -> Compiler Options.
...
* Solution: Press F11 instead of F10 to compile it first. If it still fails, ensure your file path does not contain special characters or spaces, and that you have permission to write to the folder (avoid compiling files directly inside C:\Program Files or system folders).
